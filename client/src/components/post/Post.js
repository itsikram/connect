...
let Post = (props) => {
    ...
    let postAuthorPP = `${serverConfig.SERVER_URL}image/uploads/${post.author.profilePic}`
    let postPhoto = `${serverConfig.SERVER_URL}image/uploads/${post.photos}`
        ...
        <div className={`nf-post ${type}`}>
                                <div className="header">
                                            ...
                                            <div className="author-info">
                                                <div className="left">
                                                    <div className="author-pp">
                                                        <UserPP profilePic={postAuthorPP} active={true}></UserPP>
                                                    </div>
                                        ...
                                        <div className="footer">
                                            ...
                                            <PostComment post={post} myProfile={myProfile} authProfilePicture={authProfilePicture}></PostComment>
