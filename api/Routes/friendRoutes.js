...
const {postFrndReq,postRemoveFrnd,postRemoveFrndReq,getFrndReq,getProfileSuggetions,getProfileFrnd,postFrndAccept,postFrndDelete} = require('../controllers/friendController')
